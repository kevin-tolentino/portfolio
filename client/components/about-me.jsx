...
function AboutMe(props) {
  return (
    <div className={props.background}>
      <div id="about-me" className="container-xl component d-flex align-items-center">
        <div className="row py-2 align-items-center">
          ...
          <div className="p-3 col-md-7">
            <h2>About Me</h2>
            <p className='about-me-p'>Hi there! My name is Kevin Tolentino, and I&apos;m a Software Engineer passionate about developing web applications that serve other people&apos;s needs.</p>
